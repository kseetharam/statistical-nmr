...
if __name__ == "__main__":
    ...
    # sd = 0.105
        ...
        n_epochs = {
            ...
            "Hamiltonian": {"num_steps": 50, "nn_off": True, "h_mat_off": False},
            "Neural Net": {"num_steps": 50, "nn_off": False, "h_mat_off": True},
            "Warm-up2": {"num_steps": 50, "nn_off": False, "h_mat_off": False},
            "Hamiltonian2": {"num_steps": 50, "nn_off": True, "h_mat_off": False},
            "Neural Net2": {"num_steps": 50, "nn_off": False, "h_mat_off": True},
            "Warm-up3": {"num_steps": 50, "nn_off": False, "h_mat_off": False},
            "Hamiltonian3": {"num_steps": 50, "nn_off": True, "h_mat_off": False},
            "Neural Net3": {"num_steps": 50, "nn_off": False, "h_mat_off": True},
        }
        total_epochs = 12
        ...
        jnp.savez(f"{path.stem}_HL-NODE16-SD={sd}-Fitted.npz", ppm=final_ppm, spec=final_FTspec, fid=final_fid)
        jnp.savez(f"{path.stem}_HL-NODE16-SD={sd}-GT.npz", ppm=gt_ppm, spec=gt_FTspec, fid=gt_fid)
        jnp.savez(f"{path.stem}_HL-NODE16-SD={sd}-Initial.npz", ppm=init_ppm, spec=init_FTspec, fid=init_fid)
